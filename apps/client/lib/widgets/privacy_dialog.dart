          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildPrivacyItem(l10n.get('data_only_publish_send_to_you_config_ai_service')),
                _buildPrivacyItem(l10n.get('not_will_save_storage_to_we_service_device')),
                _buildPrivacyItem(l10n.get('you_can_revoke_authorization_in_settings')),
              ],
            ),
          ),
        ],
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text(
                  l10n.get('your_data_security_is_our_priority'),
